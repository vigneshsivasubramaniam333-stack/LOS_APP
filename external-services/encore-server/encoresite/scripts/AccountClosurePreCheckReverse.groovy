...
logger.info("AccountClosurePreCheckReverse Script.")
...
for(AccountEntry accountEntry: disbAccountEntries) {
    ...
    if(profile.getProductCode().equals("3821050") && accountEntry.getAccountEntryType() == AccountEntry.AccountEntryType.CREDIT) {
        ...
        marginMoneyAccountEntry.setAccountEntryType(AccountEntry.AccountEntryType.CREDIT)
        ...
        if(advanceEmiAccountId != null) {
            ...
            advanceEmiEntry.setAccountEntryType(AccountEntry.AccountEntryType.DEBIT);
