...
| Variable | Purpose |
|----------|---------|
| `ENCORE_BASE_URL` | Encore API base URL (Credinnov sandbox: `http://host.docker.internal:8091/credinnov-encore-server/encore/` — matches nginx `proxy_pass http://127.0.0.1:8091/credinnov-encore-server/`) |
