...
export function friendlyStatusHeadline(status: ApplicationStatus): string {
  const m: Record<ApplicationStatus, string> = {
    ...
    ANCHOR_CONSENT_PENDING: 'Waiting for your consent',
    ANCHOR_SUBMITTED: 'Submitted — we are reviewing your details',
    ANCHOR_SENT_BACK: 'Please update your application',
    ...
    DOC_VERIFICATION_PENDING: 'Document verification in progress',
    DOC_VERIFICATION_SENT_BACK: 'Please update your documents',
