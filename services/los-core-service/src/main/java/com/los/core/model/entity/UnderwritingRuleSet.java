...
@Entity
@Table(name = "underwriting_rule_sets")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class UnderwritingRuleSet {
    ...
    /** Optional: e.g. {"state":"KA","city":"Bengaluru"} — omitted fields are not matched */
    ...
    @Builder.Default
    private Map<String, Object> rulesJson = Map.of();
