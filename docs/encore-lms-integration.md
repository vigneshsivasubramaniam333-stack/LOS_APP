...
| Variable | Purpose |
|----------|---------|
| `ENCORE_BASE_URL` | Encore API base URL (Credinnov sandbox: `http://host.docker.internal:8091/encore/` from Docker, or `http://credinnov-sandbox.senseitech.com/credinnov-encore-server/encore/` via nginx) |
